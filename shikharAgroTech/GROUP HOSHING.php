<!--A Design by Ecare Communications
Author: Ecare Communications
Author URL: http://www.ecarecommunications.in
      ...
      <div class="shop_top">
		<div class="container">
			<div class="row ex_box" style=" margin-left:393px; ">
				<h3 class="m_2">GROUP HOUSHING</h3>
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITH SERVANT ROOM/01 (12).jpg" data-fancybox-group="gallery" title="GROUP HOUSHING"><img src="images/30X60 WITH SERVANT ROOM/01 (12).jpg" class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						GROUP HOUSHING
					</div>
				</a></div>
				</div>
				<div class="col-md-4 team1" style="margin-top:-8px;">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITH SERVANT ROOM/site plan.jpg" data-fancybox-group="gallery" title="Site-plane"><img src="images/30X60 WITH SERVANT ROOM/site plan.jpg"  class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						Site Plan
					</div>
				</a></div>
		    ...
		    <div class="row ex1_box" style=" margin-left:393px; ">
			   <div class="col-md-4 team1">
				...
				<div class="img_section magnifier2">
				        ...
				        <!-- end product_slider -->
				        <div class="single_right" style="width: 179.5%;
    float: left;
    margin-left: -990px;
    margin-top: -318px;">
				        	<h3>GROUP HOUSHING</h3>
							<br>
				        	...
				        	<ul class="options">
								<h4 class="m_12">Plot Size &raquo; <span style=" font-size:18px; font-weight:100">XXX</span>Sqft</h4>
								
								<li><a >3BHK</a></li>&raquo; 1300sqft <br><br>
								<li><a >2BHK</a></li>&raquo; 900sqft &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
								<li><a >1BHK</a></li>&raquo; 600sqft<br><br>
