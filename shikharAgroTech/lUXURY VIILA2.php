		...
		<div class="container">
			<div class="row ex_box" style=" margin-left:393px; ">
				...
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITHOUT SERVANT ROOM/VIEW_A.jpg" data-fancybox-group="gallery" title="View-A"><img src="images/30X60 WITHOUT SERVANT ROOM/VIEW_A.jpg" class="img-responsive" alt=""><span> </span>
				...
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITHOUT SERVANT ROOM/VIEW_B.jpg" data-fancybox-group="gallery" title="View-B"><img src="images/30X60 WITHOUT SERVANT ROOM/VIEW_B.jpg"  class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						View-B
					</div>
				</a></div>
				...
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITHOUT SERVANT ROOM/VIEW_.C..jpg" data-fancybox-group="gallery" title="View-C"><img src="images/30X60 WITHOUT SERVANT ROOM/VIEW_.C..jpg"  class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						View-C
					</div>
				</a></div>
		    ...
		    <div class="row ex_box" style=" margin-left:393px; ">
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITHOUT SERVANT ROOM/G.F. FINAl OPTION.jpg" data-fancybox-group="gallery" title="Ground floor layout"><img src="images/30X60 WITHOUT SERVANT ROOM/G.F. FINAl OPTION.jpg" class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						Ground floor layout
					</div>
				</a></div>
				...
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITHOUT SERVANT ROOM/F.F. FINAL.jpg" data-fancybox-group="gallery" title="First floor layout"><img src="images/30X60 WITHOUT SERVANT ROOM/F.F. FINAL.jpg"  class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						First floor layout
					</div>
				</a></div>
				...
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/30X60 WITHOUT SERVANT ROOM/S.F. FINAL.jpg" data-fancybox-group="gallery" title="Second floor layout"><img src="images/30X60 WITHOUT SERVANT ROOM/S.F. FINAL.jpg" class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						Second floor layout
					</div>
				</a></div>
			   ...
			   <div class="col-md-4 team1">
				...
				<div class="img_section magnifier2">
				        ...
				        <div class="single_right">
				        	<h3>Luxury Villa Without Servent Room</h3>
							<br>
				        	...
				        	<ul class="options">
								...
								<li><a >Second Flour</a></li>&raquo; 800sqft<br><br>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<ul class="footer_box">
							<h4>Projects</h4>
							<li><a href="LUXURY VIILA.html">LUXURY VIILA</a></li>
							<li><a href="ROW HOUSHING.html">ROW HOUSHING</a></li>
							<li><a href="GROUP HOSHING.html">GROUP HOUSHING</a></li>
					...
					<div class="col-md-3">
						<ul class="footer_box">
							...
							<li><a href="#">REGIONAL OFFICE</a></li>
				...
				<div class="row footer_bottom">
				    <div class="copy">
			           <p>© 2015 <a href="http://shikharagrotech.com" target="_blank">SHIKHAR AGROTECH</a> and developed by <a href="http://ecarecommunications.in" tabindex="_blank">Ecare Communications</a></p>
		            </div>
