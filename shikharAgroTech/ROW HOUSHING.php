      ...
      <div class="shop_top">
		<div class="container">
			<div class="row ex_box" style=" margin-left:393px; ">
				<h3 class="m_2">Row-Houshing</h3>
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/22x45 row/G.F. FINAL.jpg" data-fancybox-group="gallery" title="Ground floor layout"><img src="images/22x45 row/G.F. FINAL.jpg" class="img-responsive" alt=""><span> </span>
				...
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/22x45 row/F.F. FINAL.jpg" data-fancybox-group="gallery" title="First floor layout"><img src="images/22x45 row/F.F. FINAL.jpg"  class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						First floor layout
					</div>
				</a></div>
				...
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/22x45 row/S,F.jpg" data-fancybox-group="gallery" title="Second floor layout"><img src="images/22x45 row/S,F.jpg"  class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						Second floor layout
					</div>
				</a></div>
		    ...
		    <div class="row ex_box" style=" margin-left:393px; ">
				<div class="col-md-4 team1">
				<div class="img_section magnifier2">
				  <a class="fancybox" href="images/22x45 row/01 (15).jpg" data-fancybox-group="gallery" title="Row-Houshing"><img src="images/22x45 row/01 (15).jpg" class="img-responsive" alt=""><span> </span>
					<div class="img_section_txt">
						Row-Houshing
					</div>
				</a></div>
			   ...
			   <div class="col-md-4 team1">
				...
				<div class="img_section magnifier2">
				        ...
				        <div class="single_right">
				        	...
				        	<ul class="options">
								<h4 class="m_12">Plot Size &raquo; <span style=" font-size:18px; font-weight:100">22x45</span>Sqft</h4>
								<h4 class="m_12">area &raquo; cover area &raquo; 900sqft</h4> 
								<li><a >Ground Flour</a></li>&raquo; 875sqft <br><br>
								<li><a >First Flour&nbsp;&nbsp;&nbsp;&nbsp;</a></li>&raquo; 875sqft &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
								<li><a >Second Flour</a></li>&raquo; 540sqft<br><br>
