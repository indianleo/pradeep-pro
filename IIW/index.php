...
<html>
    ...
    <body>
        ...
        <div class="top_container full_width" id="top_container">
            ...
            <div class="top_title">
                <h1 class="text-center">Welcome in Indian Information World</h1>
            </div>
            ...
            <div class="member_box center">
                <div class="member_btn row_style center effect">
                    <span><a href="#" source="login_box" onclick="modalLocal(this)">Login</a></span>
                </div>
                <div class="member_btn row_style center effect" style="width:170px;">
                    <span><a href="upload.php" >Upload Information</a></span>
                </div>
                <div class="member_btn row_style center effect">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="tiles_item center vFlex bg_black">
                            ...
                            <div class="tiles_content text-center h_padding text_white" style="padding-top:15px;padding-bottom:50px;">
                                <span>
                            ...
                            <div class="tiles_tag text-center" style="height:30px;color:#00cc99;">
                                <span>A plateform to know anything</span>
                            </div>
                            <div class="tiles_btn btn_style text_white" style="border:1px solid #e6e6e6;">
                                <span><a href="search.php" class="text_white">Explore</a></span>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="tiles_item center vFlex bg_black">
                            ...
                            <div class="tiles_title text-center text_white" style="font-size:28px;">
                                <span>Your Openions</span>
                            </div>
                            <div class="tiles_tag text-center" style="height:30px;color:#00cc99;">
                                <span>A place to update stuff</span>
                            </div>
                            <div class="tiles_btn btn_style text_white" style="border:1px solid #e6e6e6;">
                                <span><a href="user_view.php" class="text_white">Explore</a></span>
                            </div>
                            <div style="height:50px;"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="tiles_item center vFlex bg_black">
                            ...
                            <div class="tiles_tag text-center" style="height:30px;color:#00cc99;">
                                <span>An interface to share</span>
                            </div>
                            <div class="tiles_btn btn_style text_white" style="border:1px solid #e6e6e6;">
                                <span><a href="share.php" class="text_white">Explore</a></span>
                            </div>
                            <div style="height:50px;"></div>
                        </div>
                    </div>
